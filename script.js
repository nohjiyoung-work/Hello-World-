...
const KOR_TEXTS = [
  {
    heading: '저는 말이죠...',
    body: '2000년 5월, 영화 <span class="bracket">&lt;</span><a class="inline-link" href="https://ko.wikipedia.org/wiki/%EC%A1%B4_%EB%A7%90%EC%BD%94%EB%B9%84%EC%B9%98_%EB%90%98%EA%B8%B0" target="_blank">존 말코비치되기</a><span class="bracket">&gt;</span>가 한국에서 개봉하던 시기에 태어났어요. 한양대학교에서 커뮤니케이션디자인을 공부했고, University of Leed에서 Graphic Design course를 교환유학했어요.'
  },
  {
    heading: '인생의 숙제, 디자인은...',
  ...
  {
    heading: '요즘엔...',
    body: '헤비 영화 평점 앱 유저, 맨날 한 번씩 들어가서 <a class="inline-link" href="https://pedia.watcha.com/ko-KR/users/RE952E8RnvQ72" target="_blank">왓챠피디아</a>에서 남의 리뷰를 훔쳐봐요. 방구석 음악 평론가, 좋은 음악을 들으면 비둘기처럼 고개를 까딱거리는 걸 즐겨해요. 현재 Rave sound에 빠져 특히 <a class="inline-link" href="https://www.youtube.com/watch?v=MMSfBy2gdT4&feature=youtu.be" target="_blank">Fred again</a>과 사랑에 빠졌어요.'
  },
  {
    heading: null,
...
const ENG_TEXTS = [
  {
    heading: 'I am...',
    body: 'I was born in May 2000, right around the time <span class="bracket">&lt;</span><a class="inline-link" href="https://en.wikipedia.org/wiki/Being_John_Malkovich" target="_blank">Being John Malkovich</a><span class="bracket">&gt;</span> hit Korean theaters. I studied Communication Design at Hanyang University and spent some time diving into Graphic Design at the University of Leeds.'
  },
  {
  ...
  {
    heading: 'Lately, I\u2019m\u2026',
    body: 'A heavy <a class="inline-link" href="https://letterboxd.com/jijiya_hi/" target="_blank">Letterboxd</a> user who steals a peek at others\u2019 reviews every single day. An armchair music critic who can\u2019t help but nod like a pigeon whenever a banger comes on. Currently obsessed with Rave sounds\u2014and yes, I\u2019m deeply in love with <a class="inline-link" href="https://www.youtube.com/watch?v=MMSfBy2gdT4&feature=youtu.be" target="_blank">Fred again</a>..'
  },
  {
    heading: null,
